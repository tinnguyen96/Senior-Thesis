...
function [gama_list, status_list] = function_dsos_putinar_pursuit_ver2(N, on_PC,...
    ...
    dir_name = strcat('function_dsos_putinar_pursuit_ver2_N=',num2str(N),...
        'deq=',num2str(max_deq),'dineq=',num2str(max_dineq),'d0=',num2str(max_d0),...
        'method=',num2str(method),'tol=',num2str(tol));
    ...
    % Don't use basis identification (it's slow)
